...
import com.willfp.ecocollections.api.completedCollectionCount
...
import com.willfp.ecocollections.api.unlockedCollectionCount
...
class Collection(
    ...
    // Tier rewards: tier-specific and "all" tier rewards
    ...
    // Lore cache keyed by compound key: "collection_id:tier:unlocked_state"
    ...
    /**
     * Returns the tier for a given count.
     * Tier N is reached when count >= tierRequirements[N-1].
     * Tier 0 = not started.
     */
    ...
    /**
     * Register all PlaceholderAPI placeholders for this collection.
     */
    private fun registerPlaceholders() {
        // Per-collection placeholders
        ...
        // Global placeholders (registered once per reload cycle, but safe to re-register)
        ...
        // Leaderboard top-N placeholders
        for (n in 1..10) {
    ...
    /**
     * Per spec 15: warn if mine_block/break_block used without player_placed filter.
     */
